...
<body>
  ...
  <div class="container bg-light text-center p-3 mt-4 mb-3 border rounded">
    <div class="display-3"> Entrada de Mercadorias</div>
  </div>
            ...
            <form role="form" action="" method="GET">
              ...
              <div class="justify-content-center">
                <div class="btn btn-lg btn-block">
                  <button id="btnRegistrar" type="submit" class="btn btn-info btn-lg btn-block" onclick="validarCNPJ()"> CONSULTAR </button>
                </div>
 ...
 <script type="text/javascript">
    ...
    function validarCNPJ() {
      ...
      var cnpjCons = document.getElementById("cnpjCons");
      var cnpjCons = String(cnpjCons).replace(/[^\d]/g, '');
      var cnpjConsVal = parseFloat(cnpjCons);
 

     
    if (cnpjConsVal.length == ''){
        alert("CNPJ INVÁLIDO!");
